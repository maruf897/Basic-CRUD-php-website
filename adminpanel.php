...
$conn=mysqli_connect($host,$username,$password,$db_name);
    ...
    $sql="SELECT * FROM $tbl_name WHERE user_id= '$userid';";
...
<html lang="en">
  ...
  if($count<1){
    echo '<h3 class="text-center">You have no charities added.</h3>';
  }
 ...
 <a href="showcharity.php?id=<?php echo $row['charity_id']; ?>">
   ...
   <a class="btn btn-success " href="editcharity.php?id=<?php echo $row['charity_id']; ?>">Edit</a>
   <a class="btn btn-danger " href="deletecharity.php?id=<?php echo $row['charity_id']; ?>">Delete</a>
