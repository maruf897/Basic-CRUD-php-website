...
<html lang="en">
  ...
  <div class="card-body">
    <h6 class="card-title">Subject: <?php echo $row['name']; ?></h6>
    <h6 class="card-subtitle mb-2 ">Date: <?php echo $row['date']; ?></h6>
    <h6 class="card-text mb-2  m-1">Message: <?php echo $row['message']; ?></h6>
    <p class="card-text">Mail: <?php echo $row['email']; ?></p>
    <p class="card-text">Phone: <?php echo $row['phone']; ?></p>
    <a class="btn btn-danger " href="deletemessage.php?id=<?php echo $row['form_id']; ?>">Delete</a>
